   ...
   blurSettings = {
	...
	const spatialPositions = useMemo(() => {
		...
		for (let i = 0; i < visibleCount; i++) {
			// Spread images at random angles and radii for a more organic, scattered look
			const angle = Math.random() * Math.PI * 2;
			const radius = maxHorizontalOffset * (0.7 + Math.random() * 0.8); // 0.7 to 1.5 of max offset
